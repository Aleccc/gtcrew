# Generated by Django 2.0.7 on 2019-02-14 02:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gtid', models.CharField(blank=True, max_length=9, null=True, unique=True, validators=[django.core.validators.RegexValidator('^(\\d){9}$')], verbose_name='GT ID')),
